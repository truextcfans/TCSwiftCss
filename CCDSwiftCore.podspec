...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'http://git.2dfire-inc.com/2dfire-ios/CCDSwiftCore'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'truextcfans' => 'xietiancai@thinker.vc' }
  s.source           = { :git => 'http://git.2dfire-inc.com/2dfire-ios/CCDSwiftCore.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'CCDSwiftCore' => ['CCDSwiftCore/Assets/*.png']
  # }
